                                            ...
                                            if ($key === $listTitles[$i]) : ?>
                                                <td>
                                                    <?php if ($key === 'sm_nameFunction') {?>
                                                        <a title="<?= $strings['Show Functionality']?>" href='FUNCTIONALITY_Controller.php?action=Show&function=<?= $this->functions[$j]['sm_idFunction']?>'><?= $value?></a>                
                                                    <?php }else {
                                                        echo $value;
                                                    } ?>
                                                </td>
                                            ...
                                            <div id="item-<?= $this->functions[$j]['sm_idFunction']?>" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST" action="FUNCTIONALITY_Controller.php?action=Delete">

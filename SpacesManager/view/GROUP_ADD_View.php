			...
			<div class="row center-row">
				<div class="col-lg-6 center-block">
					...
					<div class="col-lg-12 center-block-content">
						<form method="POST" action="GROUP_Controller.php?action=<?= $strings['Add']?>" onkeyup="validateGroup(this)">
							<div id="group-form">
								...
								<button id="saveButton" type="submit" name="submit" class="btn-dark" onclick="validatePermissions()" disabled><?= $strings["Save"]?></button>
							</div> 
						</form>

...
class SPACE_EDIT_PLANE{
    ...
    function render() {
			...
			<div id="titleView">
				...
				<form method="POST" action="SPACE_Controller.php?action=<?= $strings['EditSpacePlane']?>&building=<?= $this->space['sm_idBuilding']?>&floor=<?= $this->space['sm_idFloor']?>&space=<?= $this->space['sm_idSpace']?>">

...
$tests['SM_FLOOR_ADD_TEST2']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 2. Attempt to add floor with building's identifier less than 5 characters",
                'Expected' => "Building identifier can't be less than 5 characters",
                'Result' => 'Not executed']);

$floor = new FLOOR_Model('1234');
$addAnswer = $floor->addFloor();
$tests['SM_FLOOR_ADD_TEST2']["Result"] = $addAnswer;

$tests['SM_FLOOR_ADD_TEST3']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 3. Attempt to add floor with building's identifier bigger than 5 characters",
...
$tests['SM_FLOOR_ADD_TEST4']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 4. Attempt to add floor with building's identifier format invalid",
...
$tests['SM_FLOOR_ADD_TEST5']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 5. Attempt to add floor with floor identifier that not exists in DB",
                'Expected' => "There isn't a building with that identifier",
                'Result' => 'Not executed']);

$floor = new FLOOR_Model('00000');
$addAnswer = $floor->addFloor();
...
$tests['SM_FLOOR_ADD_TEST6']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 6. Attempt to add floor without floor identifier",
...
$tests['SM_FLOOR_ADD_TEST7']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 7. Attempt to add floor with floor identifier less than 2 characters",
                'Expected' => "Floor identifier can't be less than 2 characters",
                'Result' => 'Not executed']);

$floor = new FLOOR_Model('OSBI0', '1');
$addAnswer = $floor->addFloor();
$tests['SM_FLOOR_ADD_TEST7']["Result"] = $addAnswer;


$tests['SM_FLOOR_ADD_TEST8']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 8. Attempt to add floor with floor identifier bigger than 2 characters",
...
$tests['SM_FLOOR_ADD_TEST9']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 9. Attempt to add floor with floor identifier format invalid",
...
$tests['SM_FLOOR_ADD_TEST10']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 10. Attempt to add floor without floor name",
...
$tests['SM_FLOOR_ADD_TEST11']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 11. Attempt to add floor with floor name bigger than 255 characters",
...
$tests['SM_FLOOR_ADD_TEST12']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 12. Attempt to add floor with floor name format invalid",
...
$tests['SM_FLOOR_ADD_TEST13']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 13. Attempt to add floor with building surface bigger than 99999999.99",
...
$tests['SM_FLOOR_ADD_TEST14']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 14. Attempt to add floor with useful surface bigger than 99999999.99",
                'Expected' => "Floor useful surface can't be long than 99999999.99",
                'Result' => 'Not executed']);

$floor = new FLOOR_Model('OSBI0', '99', 'nameFloor', '', 1000.00, 100000000.00);
$addAnswer = $floor->addFloor();
$tests['SM_FLOOR_ADD_TEST14']["Result"] = $addAnswer;


$tests['SM_FLOOR_ADD_TEST15']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 15. Attempt to add floor with useful surface bigger than building surface",
...
$tests['SM_FLOOR_ADD_TEST16']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 16. Attempt to add floor with plan file extension invalid",
...
$addAnswer = $floor->addFloor();
$tests['SM_FLOOR_ADD_TEST16']["Result"] = $addAnswer;



//TESTS ALL FLOOR

$tests['SM_FLOOR_ADD_TEST17']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 17. Attempt to add floor that already exists in the building",
...
$addAnswer = $floor->addFloor();
$tests['SM_FLOOR_ADD_TEST17']["Result"] = $addAnswer;



//FINAL TEST -> ADD FLOOR

$tests['SM_FLOOR_ADD_TEST18']=(['Functionality' => "SM_FLOOR_ADD",
                'Description' => "Test 18. Attempt to add floor with correct values",
...
$addAnswer = $floor->addFloor();
if($addAnswer === true){
    $tests['SM_FLOOR_ADD_TEST18']["Result"] = 'Floor added successfully';
}else{
    $tests['SM_FLOOR_ADD_TEST18']["Result"] = $addAnswer;
}

...
$tests['SM_BUILDING_ADD_TEST3']=(['Functionality' => "SM_BUILDING_ADD",
                'Description' => "Test 3. Attempt to add building with identifier bigger than 5 characters",
...
$tests['SM_BUILDING_ADD_TEST4']=(['Functionality' => "SM_BUILDING_ADD",
                'Description' => "Test 4. Attempt to add building with identifier format invalid",
...
$tests['SM_BUILDING_ADD_TEST5']=(['Functionality' => "SM_BUILDING_ADD",
                'Description' => "Test 5. Attempt to add building without name",
...
$tests['SM_BUILDING_ADD_TEST6']=(['Functionality' => "SM_BUILDING_ADD",
                'Description' => "Test 6. Attempt to add building with name bigger than 255 characters",
...
$tests['SM_BUILDING_ADD_TEST7']=(['Functionality' => "SM_BUILDING_ADD",
                'Description' => "Test 7. Attempt to add building with name format invalid",
...
$tests['SM_BUILDING_ADD_TEST8']=(['Functionality' => "SM_BUILDING_ADD",
                'Description' => "Test 8. Attempt to add building without address",
...
$tests['SM_BUILDING_ADD_TEST9']=(['Functionality' => "SM_BUILDING_ADD",
                'Description' => "Test 9. Attempt to add building with address bigger than 255 characters",
...
$tests['SM_BUILDING_ADD_TEST10']=(['Functionality' => "SM_BUILDING_ADD",
                'Description' => "Test 10. Attempt to add building with address format invalid",
...
$tests['SM_BUILDING_ADD_TEST11']=(['Functionality' => "SM_BUILDING_ADD",
                'Description' => "Test 11. Attempt to add building without phone",
...
$tests['SM_BUILDING_ADD_TEST12']=(['Functionality' => "SM_BUILDING_ADD",
                'Description' => "Test 12. Attempt to add building with phone bigger than 9 characters",
                'Expected' => 'Building phone is incorrect',
                'Result' => 'Not executed']);
...
$tests['SM_BUILDING_ADD_TEST13']=(['Functionality' => "SM_BUILDING_ADD",
                'Description' => "Test 13. Attempt to add building with phone format invalid",
...
$tests['SM_BUILDING_ADD_TEST14']=(['Functionality' => "SM_BUILDING_ADD",
                'Description' => "Test 14. Attempt to add building with identifier that it already exists in BD",
...
$tests['SM_BUILDING_ADD_TEST15']=(['Functionality' => "SM_BUILDING_ADD",
                'Description' => "Test 15. Attempt to add building with correct values",
...
$addAnswer = $building->addBuilding();
if($addAnswer === true){
    $tests['SM_BUILDING_ADD_TEST15']["Result"] = 'Building added successfully';
}else{
    $tests['SM_BUILDING_ADD_TEST15']["Result"] = $addAnswer;
}

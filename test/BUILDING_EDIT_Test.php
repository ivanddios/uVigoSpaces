...
$tests['SN_BUILDING_EDIT_TEST2']=(['Functionality' => "SN_BUILDING_EDIT",
                                    'Description' => "Test 2. Attempt to update building with identifier less than 5 characters",
                                    'Expected' =>  "Building identifier can't be less than 5 characters",
                                    'Result' => 'Not executed']);

$building = new BUILDING_Model('1234');
$editAnswer = $building->updateBuilding();
$tests['SN_BUILDING_EDIT_TEST2']["Result"] = $editAnswer;


$tests['SN_BUILDING_EDIT_TEST3']=(['Functionality' => "SN_BUILDING_EDIT",
                                    'Description' => "Test 3. Attempt to update building with identifier bigger than 5 characters",
...
$tests['SN_BUILDING_EDIT_TEST4']=(['Functionality' => "SN_BUILDING_EDIT",
                                    'Description' => "Test 4. Attempt to update building with identifier format invalid",
...
$tests['SN_BUILDING_EDIT_TEST5']=(['Functionality' => "SN_BUILDING_EDIT",
                                'Description' => "Test 5. Attempt to update building without name",
...
$tests['SN_BUILDING_EDIT_TEST6']=(['Functionality' => "SN_BUILDING_EDIT",
                                'Description' => "Test 6. Attempt to update building with name bigger than 255 characters",
...
$tests['SN_BUILDING_EDIT_TEST7']=(['Functionality' => "SN_BUILDING_EDIT",
                                'Description' => "Test 7. Attempt to update building with name format invalid",
...
$tests['SN_BUILDING_EDIT_TEST8']=(['Functionality' => "SN_BUILDING_EDIT",
                                'Description' => "Test 8. Attempt to update without address",
...
$tests['SN_BUILDING_EDIT_TEST9']=(['Functionality' => "SN_BUILDING_EDIT",
                            'Description' => "Test 9. Attempt to update building with address bigger than 255 characters",
...
$tests['SN_BUILDING_EDIT_TEST10']=(['Functionality' => "SN_BUILDING_EDIT",
                                    'Description' => "Test 10. Attempt to update building with address format invalid",
...
$tests['SN_BUILDING_EDIT_TEST11']=(['Functionality' => "SN_BUILDING_EDIT",
                                'Description' => "Test 11. Attempt to update building without phone",
...
$tests['SN_BUILDING_EDIT_TEST12']=(['Functionality' => "SN_BUILDING_EDIT",
                                'Description' => "Test 12. Attempt to update building with phone bigger than 9 characters",
                                'Expected' => 'Building phone is incorrect',
                                'Result' => 'Not executed']);
...
$tests['SN_BUILDING_EDIT_TEST13']=(['Functionality' => "SN_BUILDING_EDIT",
                                'Description' => "Test 13. Attempt to update building with phone format invalid",
...
$tests['SN_BUILDING_EDIT_TEST14']=(['Functionality' => "SN_BUILDING_EDIT",
                                'Description' => "Test 14. Attempt to update building with identifier that not exists in BD",
...
$tests['SN_BUILDING_EDIT_TEST15']=(['Functionality' => "SN_BUILDING_EDIT",
                                'Description' => "Test 15. Attempt to update building with correct values",
...
$editAnswer = $building->updateBuilding();
if($editAnswer === true){
    $tests['SN_BUILDING_EDIT_TEST15']["Result"] = 'Building updated successfully';
}else{
    $tests['SN_BUILDING_EDIT_TEST15']["Result"] = $editAnswer;
}

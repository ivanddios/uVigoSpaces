...
$tests['SM_SPACE_ADD_TEST2']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 2. Attempt to add space with building's identifier less than 5 characters",
...
$tests['SM_SPACE_ADD_TEST3']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 3. Attempt to add space with building's identifier bigger than 5 characters",
...
$tests['SM_SPACE_ADD_TEST4']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 4. Attempt to add space with building's identifier format invalid",
...
$tests['SM_SPACE_ADD_TEST5']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 5. Attempt to add space with floor identifier that not exists in DB",
                'Expected' => "There isn't a building with that identifier",
                'Result' => 'Not executed']);

$space = new SPACE_Model('01001');
$addAnswer = $space->addSpace();
...
$tests['SM_SPACE_ADD_TEST6']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 6. Attempt to add space without floor identifier",
...
$tests['SM_SPACE_ADD_TEST7']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 7. Attempt to add space with floor identifier bigger than 2 characters",
...
$tests['SM_SPACE_ADD_TEST8']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 8. Attempt to add space with floor identifier format invalid",
...
$tests['SM_SPACE_ADD_TEST9']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 9. Attempt to add space with floor that no exists in the building",
...
$tests['SM_SPACE_ADD_TEST10']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 10. Attempt to add space without space identifier",
...
$tests['SM_SPACE_ADD_TEST11']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 11. Attempt to add space with space identifier less than 5 characters",
...
$tests['SM_SPACE_ADD_TEST12']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 12. Attempt to add space with space identifier bigger than 5 characters",
...
$tests['SM_SPACE_ADD_TEST13']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 13. Attempt to add space with space identifier format incorrect",
                'Expected' => "Space identifier is invalid",
                'Result' => 'Not executed']);

$space = new SPACE_Model('OSBI0', '00', 'abcde');
$addAnswer = $space->addSpace();
...
$tests['SM_SPACE_ADD_TEST14']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 14. Attempt to add space without space name",
...
$tests['SM_SPACE_ADD_TEST15']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 15. Attempt to add space with space name bigger than 225 characters",
...
$tests['SM_SPACE_ADD_TEST16']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 16. Attempt to add space with space name format incorrect",
...
$tests['SM_SPACE_ADD_TEST17']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 17. Attempt to add space with space surface bigger than 99999999.99",
...
$tests['SM_SPACE_ADD_TEST18']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 18. Attempt to add space with space number inventory bigger than 6 characters",
                'Expected' => "Number inventory can't be larger than 6 characters",
                'Result' => 'Not executed']);

$space = new SPACE_Model('OSBI0', '00', '99999', 'nameSpace', 99.9, '1234567');
$addAnswer = $space->addSpace();
$tests['SM_SPACE_ADD_TEST18']["Result"] = $addAnswer;


$tests['SM_SPACE_ADD_TEST19']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 19. Attempt to add space with space identifier that exists in this floor's building",
                'Expected' => "There is already a space with that identifier in this floor",
                'Result' => 'Not executed']);

$space = new SPACE_Model('OSBI0', '00', '00001', 'nameSpace', 99.9, '######');
$addAnswer = $space->addSpace();
$tests['SM_SPACE_ADD_TEST19']["Result"] = $addAnswer;


//FINAL TEST
$tests['SM_SPACE_ADD_TEST20']=(['Functionality' => "SM_SPACE_ADD",
                'Description' => "Test 20. Attempt to add space with correct values",
...
$addAnswer = $space->addSpace();
if($addAnswer === true){
    $tests['SM_SPACE_ADD_TEST20']["Result"] = 'Space successfully added';
} else {
    $tests['SM_SPACE_ADD_TEST20']["Result"] = $addAnswer;
}

...
$tests['SM_FLOOR_DELETE_TEST2']=(['Functionality' => "SM_FLOOR_DELETE",
                'Description' => "Test 2. Attempt to delete floor with building's identifier less than 5 characters",
...
$tests['SM_FLOOR_DELETE_TEST3']=(['Functionality' => "SM_FLOOR_DELETE",
                'Description' => "Test 3. Attempt to delete floor with building's identifier bigger than 5 characters",
                'Expected' => "Building identifier can't be larger than 5 characters",
                'Result' => 'Not executed']);

$floor = new FLOOR_Model('123456');
$deleteAnswer = $floor->deleteFloor();
$tests['SM_FLOOR_DELETE_TEST3']["Result"] = $deleteAnswer;


$tests['SM_FLOOR_DELETE_TEST4']=(['Functionality' => "SM_FLOOR_DELETE",
                'Description' => "Test 4. Attempt to delete floor with building's identifier format invalid",
...
$tests['SM_FLOOR_DELETE_TEST5']=(['Functionality' => "SM_FLOOR_DELETE",
                'Description' => "Test 5. Attempt to delete floor with floor identifier that not exists in DB",
                'Expected' => "There isn't a building with that identifier",
                'Result' => 'Not executed']);

$floor = new FLOOR_Model('01001');
$deleteAnswer = $floor->deleteFloor();
...
$tests['SM_FLOOR_DELETE_TEST6']=(['Functionality' => "SM_FLOOR_DELETE",
                'Description' => "Test 6. Attempt to delete floor without floor identifier",
...
$tests['SM_FLOOR_DELETE_TEST7']=(['Functionality' => "SM_FLOOR_DELETE",
                'Description' => "Test 7. Attempt to delete floor with floor identifier less than 2 characters",
...
$tests['SM_FLOOR_DELETE_TEST8']=(['Functionality' => "SM_FLOOR_DELETE",
                'Description' => "Test 8. Attempt to delete floor with floor identifier bigger than 2 characters",
...
$tests['SM_FLOOR_DELETE_TEST9']=(['Functionality' => "SM_FLOOR_DELETE",
                'Description' => "Test 9. Attempt to delete floor with floor identifier format invalid",
                'Expected' => 'Floor identifier format is invalid',
                'Result' => 'Not executed']);

$floor = new FLOOR_Model('OSBI0','!;');
$deleteAnswer = $floor->deleteFloor();
$tests['SM_FLOOR_DELETE_TEST9']["Result"] = $deleteAnswer;


$tests['SM_FLOOR_DELETE_TEST10']=(['Functionality' => "SM_FLOOR_DELETE",
                'Description' => "Test 10. Attempt to delete floor with floor indentifer not exists in the building",
                'Expected' => "There isn't a floor with that identifier in the building",
                'Result' => 'Not executed']);

$floor = new FLOOR_Model('OSBI0','98');
$deleteAnswer = $floor->deleteFloor();
$tests['SM_FLOOR_DELETE_TEST10']["Result"] = $deleteAnswer;




//FINAL TEST
$tests['SM_FLOOR_DELETE_TEST11']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 1. Attempt to edit floor with correct values",
...
if($deleteAnswer === true){
    $tests['SM_FLOOR_DELETE_TEST11']["Result"] = 'Floor deleted successfully';
}else{
    $tests['SM_FLOOR_DELETE_TEST11']["Result"] = $deleteAnswer;
}

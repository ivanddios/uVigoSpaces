...
$tests['SM_SPACE_DELETE_TEST2']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 2. Attempt to delete space with building's identifier less than 5 characters",
                'Expected' => "Building identifier can't be less than 5 characters",
                'Result' => 'Not executed']);

$floor = new SPACE_Model('1234');
$deleteAnswer = $floor->deleteSpace();
...
$tests['SM_SPACE_DELETE_TEST3']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 3. Attempt to delete space with building's identifier bigger than 5 characters",
...
$tests['SM_SPACE_DELETE_TEST4']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 4. Attempt to delete space with building's identifier format invalid",
...
$tests['SM_SPACE_DELETE_TEST5']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 5. Attempt to delete space with floor identifier that not exists in DB",
                'Expected' => "There isn't a building with that identifier",
                'Result' => 'Not executed']);

$floor = new SPACE_Model('09898');
$deleteAnswer = $floor->deleteSpace();
...
$tests['SM_SPACE_DELETE_TEST6']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 6. Attempt to delete space without floor identifier",
...
$tests['SM_SPACE_DELETE_TEST7']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 7. Attempt to delete space with floor identifier less than 2 characters",
                'Expected' => "Floor identifier can't be less than 2 characters",
                'Result' => 'Not executed']);

$floor = new SPACE_Model('OSBI0', '9');
$deleteAnswer = $floor->deleteSpace();
$tests['SM_SPACE_DELETE_TEST7']["Result"] = $deleteAnswer;


$tests['SM_SPACE_DELETE_TEST8']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 8. Attempt to delete space with floor identifier bigger than 2 characters",
...
$tests['SM_SPACE_DELETE_TEST9']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 9. Attempt to delete space with floor identifier format invalid",
...
$tests['SM_SPACE_DELETE_TEST10']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 10. Attempt to delete space with floor indentifer no exists in that building",
...
$tests['SM_SPACE_DELETE_TEST11']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 11. Attempt to delete space without space identifier",
...
$tests['SM_SPACE_DELETE_TEST12']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 12. Attempt to delete space with space identifier less than 5 characters",
...
$tests['SM_SPACE_DELETE_TEST13']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 13. Attempt to delete space with space identifier bigger than 5 characters",
                'Expected' => "Space identifier can't be larger than 5 characters",
                'Result' => 'Not executed']);

$space = new SPACE_Model('OSBI0', '00', '123456');
$deleteAnswer = $space->deleteSpace();
$tests['SM_SPACE_DELETE_TEST13']["Result"] = $deleteAnswer;


$tests['SM_SPACE_DELETE_TEST14']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 14. Attempt to delete space with space identifier format incorrect",
                'Expected' => "Space identifier is invalid",
                'Result' => 'Not executed']);

$space = new SPACE_Model('OSBI0', '00', 'abcdp');
$deleteAnswer = $space->deleteSpace();
$tests['SM_SPACE_DELETE_TEST14']["Result"] = $deleteAnswer;


//TEST DELETE SPACE THAT NOT EXISTS
$tests['SM_SPACE_DELETE_TEST15']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 15. Attempt to delete space with space identifier that not exists in this floor's building",
                'Expected' => "There isn't a space with that identifier in the floor",
                'Result' => 'Not executed']);

$space = new SPACE_Model('OSBI0', '00', '12345');
$deleteAnswer = $space->deleteSpace();
$tests['SM_SPACE_DELETE_TEST15']["Result"] = $deleteAnswer;



//FINAL TEST
$tests['SM_SPACE_DELETE_TEST16']=(['Functionality' => "SM_SPACE_DELETE",
                'Description' => "Test 16. Attempt to delete space with correct values",
...
if($deleteAnswer === true){
    $tests['SM_SPACE_DELETE_TEST16']["Result"] = 'Space deleted successfully';
}else{
    $tests['SM_SPACE_DELETE_TEST16']["Result"] = $deleteAnswer;
}

...
$tests['SM_SPACE_EDIT_TEST2']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 2. Attempt to update space with building's identifier less than 5 characters",
                'Expected' => "Building identifier can't be less than 5 characters",
                'Result' => 'Not executed']);

$space = new SPACE_Model('1234');
$updateAnswer = $space->updateSpace('99999');
$tests['SM_SPACE_EDIT_TEST2']["Result"] = $updateAnswer;


$tests['SM_SPACE_EDIT_TEST3']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 3. Attempt to update space with building's identifier bigger than 5 characters",
...
$tests['SM_SPACE_EDIT_TEST4']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 4. Attempt to update space with building's identifier format invalid",
...
$tests['SM_SPACE_EDIT_TEST5']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 5. Attempt to update space with floor identifier that not exists in DB",
                'Expected' => "There isn't a building with that identifier",
                'Result' => 'Not executed']);

$space = new SPACE_Model('09090');
$updateAnswer = $space->updateSpace('99999');
...
$tests['SM_SPACE_EDIT_TEST6']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 6. Attempt to update space without floor identifier",
...
$tests['SM_SPACE_EDIT_TEST7']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 7. Attempt to update space with floor identifier less than 2 characters",
                'Expected' => "Floor identifier can't be less than 2 characters",
                'Result' => 'Not executed']);

$space = new SPACE_Model('OSBI0', '2');
$updateAnswer = $space->updateSpace('99999');
$tests['SM_SPACE_EDIT_TEST7']["Result"] = $updateAnswer;


$tests['SM_SPACE_EDIT_TEST8']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 8. Attempt to update space with floor identifier bigger than 2 characters",
...
$tests['SM_SPACE_EDIT_TEST9']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 9. Attempt to update space with floor identifier format invalid",
...
$tests['SM_SPACE_EDIT_TEST10']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 10. Attempt to update space with floor that no exists in the building",
...
$tests['SM_SPACE_EDIT_TEST11']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 11. Attempt to update space without space identifier",
...
$tests['SM_SPACE_EDIT_TEST12']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 12. Attempt to update space with space identifier less than 5 characters",
                'Expected' => "Space identifier can't be less than 5 characters",
                'Result' => 'Not executed']);

$space = new SPACE_Model('OSBI0', '00', '1234');
$updateAnswer = $space->updateSpace('99999');
$tests['SM_SPACE_EDIT_TEST12']["Result"] = $updateAnswer;


$tests['SM_SPACE_EDIT_TEST13']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 13. Attempt to update space with space identifier bigger than 5 characters",
...
$tests['SM_SPACE_EDIT_TEST14']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 14. Attempt to update space with space identifier format incorrect",
                'Expected' => "Space identifier is invalid",
                'Result' => 'Not executed']);

$space = new SPACE_Model('OSBI0', '00', 'abcdi');
$updateAnswer = $space->updateSpace('99999');
...
$tests['SM_SPACE_EDIT_TEST15']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 15. Attempt to update space without space name",
...
$tests['SM_SPACE_EDIT_TEST16']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 16. Attempt to update space with space name bigger than 225 characters",
...
$tests['SM_SPACE_EDIT_TEST17']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 17. Attempt to update space with space name format incorrect",
...
$tests['SM_SPACE_EDIT_TEST18']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 18. Attempt to update space with space surface bigger than 99999999.99",
                'Expected' => "Space surface can't be larger than 99999999.99",
                'Result' => 'Not executed']);

$space = new SPACE_Model('OSBI0', '00', '12345', 'nameSpace', 100000000.00);
$updateAnswer = $space->updateSpace('99999');
$tests['SM_SPACE_EDIT_TEST18']["Result"] = $updateAnswer;


//TEST-> NUMBER INVENTORY

$tests['SM_SPACE_EDIT_TEST19']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 19. Attempt to update space with space number inventory bigger than 6 characters",
                'Expected' => "Number inventory can't be larger than 6 characters",
                'Result' => 'Not executed']);

$space = new SPACE_Model('OSBI0', '00', '12345', 'nameSpace', 99.9, '1234567');
$updateAnswer = $space->updateSpace('99999');
$tests['SM_SPACE_EDIT_TEST19']["Result"] = $updateAnswer;


$tests['SM_SPACE_EDIT_TEST20']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 20. Attempt to update the space id for another one that is associated with another space",
                'Expected' => "There is already a space with that identifier in this floor",
                'Result' => 'Not executed']);

$space = new SPACE_Model('OSBI0', '00', '00001', 'nameSpace', 99.9, '######');
$updateAnswer = $space->updateSpace('99999');
$tests['SM_SPACE_EDIT_TEST20']["Result"] = $updateAnswer;



//FINAL TEST
$tests['SM_SPACE_EDIT_TEST21']=(['Functionality' => "SM_SPACE_EDIT",
                'Description' => "Test 21. Attempt to update space with correct values",
...
if($updateAnswer === true){
    $tests['SM_SPACE_EDIT_TEST21']["Result"] = 'Space successfully updated';
} else {
    $tests['SM_SPACE_EDIT_TEST21']["Result"] = $updateAnswer;
}

...
$tests['SM_FLOOR_EDIT_TEST2']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 2. Attempt to edit floor with building's identifier less than 5 characters",
...
$tests['SM_FLOOR_EDIT_TEST3']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 3. Attempt to edit floor with building's identifier bigger than 5 characters",
...
$tests['SM_FLOOR_EDIT_TEST4']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 4. Attempt to edit floor with building's identifier format invalid",
...
$tests['SM_FLOOR_EDIT_TEST5']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 5. Attempt to edit floor with floor identifier that not exists in DB",
...
$tests['SM_FLOOR_EDIT_TEST6']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 6. Attempt to edit floor without floor identifier",
...
$tests['SM_FLOOR_EDIT_TEST7']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 7. Attempt to edit floor with floor identifier less than 2 characters",
...
$tests['SM_FLOOR_EDIT_TEST8']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 8. Attempt to edit floor with floor identifier bigger than 2 characters",
...
$tests['SM_FLOOR_EDIT_TEST9']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 9. Attempt to edit floor with floor identifier format invalid",
...
$tests['SM_FLOOR_EDIT_TEST10']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 10. Attempt to edit floor without floor name",
...
$tests['SM_FLOOR_EDIT_TEST11']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 11. Attempt to edit floor with floor name bigger than 255 characters",
...
$tests['SM_FLOOR_EDIT_TEST12']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 12. Attempt to edit floor with floor name format invalid",
...
$tests['SM_FLOOR_EDIT_TEST13']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 13. Attempt to edit floor with building surface bigger than 99999999.99",
...
$tests['SM_FLOOR_EDIT_TEST14']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 14. Attempt to edit floor with useful surface bigger than 99999999.99",
                'Expected' => "Floor useful surface can't be long than 99999999.99",
                'Result' => 'Not executed']);

$floor = new FLOOR_Model('OSBI0', '99', 'nameFloor', '', 100000.00, 100000000.00);
$editAnswer = $floor->updateFloor();
$tests['SM_FLOOR_EDIT_TEST14']["Result"] = $editAnswer;


$tests['SM_FLOOR_EDIT_TEST15']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 15. Attempt to edit floor with useful surface bigger than building surface",
...
$tests['SM_FLOOR_EDIT_TEST16']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 16. Attempt to edit floor with plan file extension invalid",
...
$editAnswer = $floor->updateFloor();
$tests['SM_FLOOR_EDIT_TEST16']["Result"] = $editAnswer;



//MOIDY FLOOR THAT NO EXIST

$tests['SM_FLOOR_EDIT_TEST17']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 17. Attempt to edit floor that not exists in the building",
...
$editAnswer = $floor->updateFloor();
$tests['SM_FLOOR_EDIT_TEST17']["Result"] = $editAnswer;



//FINAL TEST

$tests['SM_FLOOR_EDIT_TEST18']=(['Functionality' => "SM_FLOOR_EDIT",
                'Description' => "Test 18. Attempt to edit floor with correct values",
...
$editAnswer = $floor->updateFloor();
if($editAnswer === true){
    $tests['SM_FLOOR_EDIT_TEST18']["Result"] = 'Floor updated successfully';
}else{
    $tests['SM_FLOOR_EDIT_TEST15']["Result"] = $editAnswer;
}
